...
const struct VGAAttributeControllerPaletteData                _vga_reg_mode_13h_palette_array[ATTRIBUTE_CONTROLLER_PALETTE_COUNT] = {
...
const struct VGAAttributeControllerAttributeModeControlData   _vga_reg_mode_13h_attribute_mode_control = {
...
const struct VGAAttributeControllerOverscanColorData          _vga_reg_mode_13h_overscan_color = {
    .overscan_palette_index = 0,
};
const struct VGAAttributeControllerColorPlaneEnableData       _vga_reg_mode_13h_color_plane_enable = {
    .plane_0_color_plane_enable = 1,
    .plane_1_color_plane_enable = 1,
    .plane_2_color_plane_enable = 1,
    .plane_3_color_plane_enable = 1,
};
const struct VGAAttributeControllerHorizontalPixelPanningData _vga_reg_mode_13h_horizontal_pixel_panning = {
    .pixel_shift_count = 0,
};
const struct VGAAttributeControllerColorSelectData            _vga_reg_mode_13h_color_select = {
    .color_select_5_4 = 0,
    .color_select_7_6 = 0,
};
...
void vga_set_mode_13h_attribute_controller_register(void) {
    uint8_t attribute_controller_data[ATTRIBUTE_CONTROLLER_REGISTER_COUNT] = {
        ...
        register_const_serialize(&_vga_reg_mode_13h_attribute_mode_control),
        register_const_serialize(&_vga_reg_mode_13h_overscan_color),
        register_const_serialize(&_vga_reg_mode_13h_color_plane_enable),
        register_const_serialize(&_vga_reg_mode_13h_horizontal_pixel_panning),
        register_const_serialize(&_vga_reg_mode_13h_color_select),
    };

    for (uint32_t i = 0; i < ATTRIBUTE_CONTROLLER_PALETTE_COUNT; i++)
        attribute_controller_data[i] = register_const_serialize(&_vga_reg_mode_13h_palette_array[i]);
