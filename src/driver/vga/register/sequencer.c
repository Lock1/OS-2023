...
const struct VGASequencerResetData _vga_reg_mode_13h_reset = {
    .asynchronous_reset = 1,
    .synchronous_reset  = 1,
};

const struct VGASequencerClockingModeData _vga_reg_mode_13h_clocking_mode = {
    .dot_9_8_mode    = 1,
    .shift_load_rate = 0,
    .dot_clock_rate  = 0,
    .shift_four_mode = 0,
...
const struct VGASequencerMapMaskData _vga_reg_mode_13h_map_mask = {
...
const struct VGASequencerCharacterMapData _vga_reg_mode_13h_character_map = {
    .character_set_b      = 0,
    .character_set_a      = 0,
...
const struct VGASequencerMemoryModeData _vga_reg_mode_13h_sequencer_memory_mode = {
    .extended_memory         = 1,
...
void vga_set_mode_13h_sequencer_register(void) {
    ...
    uint8_t sequencer_data[5] = {
        register_const_serialize(&_vga_reg_mode_13h_reset),
        register_const_serialize(&_vga_reg_mode_13h_clocking_mode),
        register_const_serialize(&_vga_reg_mode_13h_map_mask),
        register_const_serialize(&_vga_reg_mode_13h_character_map),
        register_const_serialize(&_vga_reg_mode_13h_sequencer_memory_mode),
    };
