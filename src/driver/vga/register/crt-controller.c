...
void vga_set_crt_controller_register(void) {
    uint8_t crt_controller_index[25] = {
        ...
        CRT_INDEX_START_HORIZONTAL_RETRACE,

        CRT_INDEX_END_HORIZONTAL_RETRACE,
        CRT_INDEX_VERTICAL_TOTAL,
        CRT_INDEX_OVERFLOW,
        CRT_INDEX_PRESET_ROW_SCAN,
        CRT_INDEX_MAXIMUM_SCANLINE,

        CRT_INDEX_CURSOR_START,
        CRT_INDEX_CURSOR_END,
        CRT_INDEX_START_ADDRESS_HIGH,
        CRT_INDEX_START_ADDRESS_LOW,
        CRT_INDEX_CURSOR_LOCATION_HIGH,

        CRT_INDEX_CURSOR_LOCATION_LOW,
        CRT_INDEX_VERTICAL_RETRACE_START,
        CRT_INDEX_VERTICAL_RETRACE_END,
        CRT_INDEX_VERTICAL_DISPLAY_END,
        CRT_INDEX_OFFSET,

        CRT_INDEX_UNDERLINE_LOCATION,
        CRT_INDEX_START_VERTICAL_BLANKING,
        CRT_INDEX_END_VERTICAL_BLANKING,
        CRT_INDEX_CRTC_MODE_CONTROL,
        CRT_INDEX_LINE_COMPARE,
    };
    ...
    vga_set_index_register(_vga_reg_port_crt_controller, CRT_INDEX_VERTICAL_RETRACE_END, 0x0E);
