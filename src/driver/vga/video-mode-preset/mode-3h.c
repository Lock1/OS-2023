#include "lib-header/driver/vga/video-mode-preset/mode-3h.h"

const struct VGAExternalRegister _vga_preset_mode_3h_external = {
    .output          = {
        .ioas             = 1,
        .ram_enable       = 1,
        .clock_select     = 0,
...
const struct VGASequencerRegister _vga_preset_mode_3h_sequencer = {
    .reset = {
...
const struct VGACRTControllerRegister _vga_preset_mode_3h_crt_controller = {
    .horizontal_total = {
...
const struct VGAGraphicsRegister _vga_preset_mode_3h_graphics = {
    .set_reset = {
        .plane_0_set_reset        = 0,
        .plane_1_set_reset        = 0,
        .plane_2_set_reset        = 0,
...
const struct VGAAttributeControllerRegister _vga_preset_mode_3h_attribute_controller = {
    .palette_array = {
...
const uint8_t _vga_preset_mode_3h_color_palette[MODE_3H_COLOR*3] = {
    00, 00, 00, 00, 00, 42, 00, 42, 00, 00, 42, 42, 42, 00, 00, 42, 
    00, 42, 42, 21, 00, 42, 42, 42, 21, 21, 21, 21, 21, 63, 21, 63, 
